...
from trustfids.server.server import XevalServer as Server
from trustfids.server.strategy import FedXeval as Strategy
...
def test_set_max_workers() -> None:
    ...
    server = Server(
        ...
        strategy=Strategy(
            initial_parameters=Parameters(tensors=[], tensor_type=""),
            num_epochs=1,
            batch_size=1,
            num_rounds=1,
        ),
